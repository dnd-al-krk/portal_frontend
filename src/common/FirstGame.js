    ...
    return (
      <div className={classes.root}>
        ...
        <Typography variant="body1" className={classes.text}>
          ...
          Po prostu zapisz się i przyjdź. Prawie wszystkie sesje odbywają się w [R’lyeh Cafe, na ulicy Lubicz 28](https://maps.app.goo.gl/ow6bB7KWjhC1Yc787) w Krakowie,
          ...
          [Tutaj możesz zapoznać się z naszymi zasadami- na pierwszą sesję wystarczy Ci wiedza o tworzeniu postaci z zasad podstawowych.](https://zasady.rpgkrakow.pl/)
        </Typography>
        <Typography variant="body1" className={classes.text}>
